...
const SpecialVersion = () => {
  require("../assets/bvi/css/bvi.min.css");
  ...
  const changeLetterSpacing = (letterSpacing) => {
    changeBviOption("bvi_letterSpacing", letterSpacing, "data-bvi-letterspacing")
  ...
  const changeBuiltElements = (builtElement) => {
    changeBviOption("bvi_builtElements", builtElement, "data-bvi-builtelements")
  ...
  const handleClickModal = (evt) => {
    ...
    if (targetEl.classList.contains("bvi-modal-close") || targetEl.querySelector(".bvi-modal-content")) {
      closeBviModal()
    }
  ...
  const resetAllActiveLinks = () => {
    const allActiveLinks = document.querySelectorAll(".bvi-panel .bvi-link.active")
  ...
  return (
    <div className="bvi-panel">
      <div className="bvi-blocks bvi-block-center">
        <div className="bvi-block bvi-block_font-size" onClick={(evt) => handleClickFontSize(evt)}>
          <div className="bvi-block-title">Размер шрифта</div>
          <a className="bvi-link bvi-fontSize-minus">А-</a>
          <a className="bvi-link bvi-fontSize-plus">А+</a>
        </div>
        <div className="bvi-block bvi-block_color-theme" onClick={(evt) => handleClickColorTheme(evt)}>
          <div className="bvi-block-title">Цвета сайта</div>
          <a href="#" className="bvi-link bvi-theme-white">
            Ц
          </a>
          <a href="#" className="bvi-link bvi-theme-black">
            Ц
          </a>
          <a href="#" className="bvi-link bvi-theme-blue">
            Ц
          </a>
          <a href="#" className="bvi-link bvi-theme-brown">
            Ц
          </a>
          <a href="#" className="bvi-link bvi-theme-green">
            Ц
          </a>
        </div>
        <div className="bvi-block bvi-block_images" onClick={(evt) => handleClickImagesMode(evt)}>
          <div className="bvi-block-title">Изображения</div>
          <a className="bvi-link bvi-images-on">
            <i className="bvi-images bvi-images-image"></i>
          </a>
          <a className="bvi-link bvi-images-off">
            <i className="bvi-images bvi-images-minus-circle"></i>
          </a>
          <a className="bvi-link bvi-images-grayscale">
            <i className="bvi-images bvi-images-adjust"></i>
          </a>
        </div>
        <div className="bvi-block bvi-block_speech" onClick={(evt) => handleClickSpeechMode(evt)}>
          <div className="bvi-block-title">Синтез речи</div>
          <a className="bvi-link bvi-speech-off">
            <i className="bvi-images bvi-images-volume-off"></i>
          </a>
          <a className="bvi-link bvi-speech-on">
            <i className="bvi-images bvi-images-volume-up"></i>
          </a>
        </div>
        <div className="bvi-block bvi-block_settings" onClick={(evt) => handleClickSettings(evt)}>
          <div className="bvi-block-title">Настройки</div>
          <a href="#" className="bvi-link" data-bvi="modal">
            <i className="bvi-images bvi-images-cog"></i>
          </a>
          <a href="#" className="bvi-link" data-bvi="close">
            Обычная версия сайта
          </a>
          <a href="#" className="bvi-link" data-bvi="panel-hide">
            <i className="bvi-images bvi-images-minus"></i>
          </a>
        </div>
      </div>
      <div className="bvi-modal" onClick={(evt) => handleClickModal(evt)}>
        <div className="bvi-modal-dialog">
          <div className="bvi-modal-content">
            <div className="bvi-modal-header">
              <div className="bvi-modal-title">Настройки</div>
              <a
                href="#"
                className="bvi-link bvi-modal-close"
                data-bvi="modal-close"
              >
                ×
              </a>
            </div>
            <div className="bvi-modal-body">
              <div className="bvi-blocks bvi-block-center">
                <div className="bvi-block bvi-block_letter-spacing">
                  <div className="bvi-block-title">Межбуквенное расстояние</div>
                  <a href="#" className="bvi-link bvi-letter-spacing-normal">
                    Стандартный
                  </a>
                  <a href="#" className="bvi-link bvi-letter-spacing-average">
                    Средний
                  </a>
                  <a href="#" className="bvi-link bvi-letter-spacing-big">
                    Большой
                  </a>
                </div>
                <div className="bvi-block bvi-block_line-height">
                  <div className="bvi-block-title">Межстрочный интервал</div>
                  <a href="#" className="bvi-link bvi-line-height-normal">
                    Стандартный
                  </a>
                  <a href="#" className="bvi-link bvi-line-height-average">
                    Средний
                  </a>
                  <a href="#" className="bvi-link bvi-line-height-big">
                    Большой
                  </a>
                </div>
                <div className="bvi-block bvi-block_font-family">
                  <div className="bvi-block-title">Шрифт</div>
                  <a href="#" className="bvi-link bvi-font-family-arial">
                    Без засечек
                  </a>
                  <a href="#" className="bvi-link bvi-font-family-times">
                    С засечками
                  </a>
                </div>
                <div className="bvi-block bvi-block_built-elements">
                  <div className="bvi-block-title">
                    Встроенные элементы (Видео, карты и тд.)
                  </div>
                  <a href="#" className="bvi-link bvi-built-elements-on">
                    Включить
                  </a>
                  <a href="#" className="bvi-link bvi-built-elements-off">
                    Выключить
                  </a>
                </div>
              </div>
              <div className="bvi-blocks bvi-block-center">
                <a
                  href="https://bvi.isvek.ru"
                  className="bvi-copyright"
                  target="_blank"
                >
                  bvi.isvek.ru
                </a>
            ...
            <div className="bvi-modal-footer">
              <a href="#" className="bvi-link bvi-reset">
                Сбросить настройки
              </a>
            </div>
          </div>
